        ...
        <div className='px-6 pb-6 space-y-4 overflow-y-auto'>
          ...
          <div className="space-y-3">
            <Button 
              ...
              disabled={!gapiLoaded || googleAuth.isLoading}
            >
              {googleAuth.isLoading ? (
                ...
                <span className="flex items-center gap-2">
                  ...
                  {googleAuth.isSignedIn ? 'Google ile devam' : 'Google ile Giriş Yap'}
                </span>
              )}
            </Button>
            <div id="google-signin-button" className="w-full h-0 opacity-0" />
          </div>

          {/* Nostr Options - Collapsed "Advanced" */}
